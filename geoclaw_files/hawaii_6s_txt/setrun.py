...
#------------------------------
    ...
    clawdata.lower[0] = 199.0      # west longitude
    clawdata.upper[0] = 206.0       # east longitude

    clawdata.lower[1] = 18.0       # south latitude
    clawdata.upper[1] = 23.0         # north latitude
...
#-------------------
    ...
    topo_path = os.path.join(scratch_dir, 'hawaii_6s.txt')
