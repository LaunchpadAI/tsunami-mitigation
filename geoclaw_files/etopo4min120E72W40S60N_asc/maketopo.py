...
def make_dtopo(makeplots=False):
    ...
    if os.path.exists(dtopo_fname):
        ...
        x = numpy.linspace(145, 155, 100)
        y = numpy.linspace(15, 25, 100)
        times = [1.]
